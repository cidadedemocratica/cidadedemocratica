ActiveSupport::Inflector.inflections do |inflect|
  ...
  # Hacks for model names in english while the legacy classes are not translated
  # needed for resources on the new routes dsl
  inflect.irregular 'competition', 'competitions'
  inflect.irregular 'inspiration', 'inspirations'
  inflect.irregular 'prize', 'prizes'
end
