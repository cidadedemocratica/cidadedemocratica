module AutoCompleteMacrosHelper
  ...
  def text_field_with_auto_complete(object, method, tag_options = {}, completion_options = {})
    field = text_field(object, method, tag_options)
    field_with_auto_complete(field, object, method, tag_options, completion_options)
  end

  def text_area_with_auto_complete(object, method, tag_options = {}, completion_options = {})
    field = text_area(object, method, tag_options)
    field_with_auto_complete(field, object, method, tag_options, completion_options)
  end

  def field_with_auto_complete(field, object, method, tag_options = {}, completion_options = {})
